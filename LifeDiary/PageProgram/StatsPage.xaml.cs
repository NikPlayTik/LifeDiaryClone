...
public partial class StatsPage : ContentPage
{
    ...
    public async Task EntriesCharts()
    {
        ...
        {
            await DisplayAlert("Ошибка", $"Не добавлены минимальные данные для записей: {ex.Message}", "Хорошо");
        }
    }
    public async Task GoalsCharts()
    {
        ...
        {
            await DisplayAlert("Ошибка", $"Не добавлены минимальные данные для целей: {ex.Message}", "Хорошо");
        }
    }
    public async Task AchievementsCharts()
    {
        ...
        {
            await DisplayAlert("Ошибка", $"Не добавлены минимальыне данные для достижений: {ex.Message}", "Хорошо");
        }
    }
